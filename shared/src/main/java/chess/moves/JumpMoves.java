...
public abstract class JumpMoves implements PieceMovesRule {
    public Collection<ChessMove> calculateJumpMoves(ChessBoard board, ChessPosition position, int[][] directions) {
        ...
        for (int[] dir : directions) {
            ...
            if (newRow >= 1 && newColumn <= 8 && newRow <= 8 && newColumn >= 1) {
